...
Rectangle* Rectangle::Parse(string stringLine) {
    string delimeter = "(), ";
    ...
    if (Rectangle::isValid(start, end)) {
        Rectangle * res = new Rectangle(start, end);
        return res;
    }
    if (Rectangle::isValid(end, start)) {
        Rectangle * res = new Rectangle(end, start);
        return res;
    }
